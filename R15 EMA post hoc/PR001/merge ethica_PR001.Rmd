...
# clear work space
# rm(list=ls())
# CEC 06/23/22: you shouldn't have to set your working directory in a R markdown
# setwd("C:/Users/madis/Dropbox/Raw Ethica data csvs and scripts to copy into your own folder here plus training video")
# set the ID name here (create another file that is PR001 and put all three csv's in there)
# id_name="PR001"
...
round(sum(is.na(dat[,-c(1:5)]))/prod(dim(dat[,-c(1:5)]))*100, 2) # 59.321
...
round(sum(is.na(dat[,-c(1:5)]))/prod(dim(dat[,-c(1:5)]))*100, 2) # 46.30%
